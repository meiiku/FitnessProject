//
//  CurrentExerciseSettingsWithTimerView.swift
//  FitnessProject
//
...
class CurrentExerciseSettingsWithTimerView: UIView {
    ...
    private lazy var nameOfExerciseLabel: CustomLabel = {
        let label = CustomLabel(text: "Squats", type: .largeAnnotation)
        return label
    }()
    ...
    private lazy var repsLabel: CustomLabel = {
        let label = CustomLabel(text: "Time of Set", type: .largeAnnotation)
        return label
    }()
...
extension CurrentExerciseSettingsWithTimerView {
